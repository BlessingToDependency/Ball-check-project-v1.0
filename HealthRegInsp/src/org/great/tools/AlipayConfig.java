...
public class AlipayConfig {
	...
	// 应用ID,您的APPID，收款账号既是您的APPID对应支付宝账号
		...
		public static String notify_url = "http://localhost:8080/HealthRegInsp/FrontEnd/notify_url.jsp";
		
		// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
		public static String return_url = "http://localhost:8080/HealthRegInsp/FrontEnd/return_url.jsp";
