              ...
              <tbody>
                ...
                <%--     <td >
                    <div style="text-align:center;height:200px;">
                              <img src="<%=path%>doctorSummaryAction/getImage.action" id="img1" style="width: 35rem; height: 15rem;">
                    </div>
                    </td> --%>
                    <td>
                          <input type="file" name="fileact" id="fileact2" multiple="multiple"/>
                              <img src="<%=path%>images/bg.jpg" id="img2" style="width: 15rem; height: 10rem;">
                    </td>
                    <td>
                          <input type="file" name="fileact" id="fileact3" multiple="multiple"/>
                              <img src="<%=path%>images/bg.jpg" id="img3" style="width: 15rem; height: 10rem;">
                    </td>
                  </tr>
