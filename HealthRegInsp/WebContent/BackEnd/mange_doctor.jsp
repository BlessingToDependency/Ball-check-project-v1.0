			...
			<tr>
			   ...
			   <td>${list.paramBean.param}</td>
                 ...
                 <span class="layui-btn layui-btn-danger" onclick="changeLogic(${list.logicId},${list.adminId})">
                    ...
                    <span class="layui-btn layui-btn-danger" onclick="changeState(${list.stateId},${list.adminId})">
      ...
      <div class="page">
        <div>
         <a class="num" href="<%=path%>maDoctorAction/selectAllDoctor.action?page=1">首页</a>
          <a class="prev" href="<%=path%>maDoctorAction/selectAllDoctor.action?page=${page-1<1?1:page-1}&adminName=${adminName}">上一页</a>
          <a class="next" href="<%=path%>maDoctorAction/selectAllDoctor.action?page=${(page+1)<=paNum?page+1:paNum}&adminName=${adminName}">下一页</a>
