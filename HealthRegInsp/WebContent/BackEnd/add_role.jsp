...
<body>
<form id="form1" name="form1" method="post" action="<%=path%>maRoleAction/innerRole.action" >
<table width="200" border="1" align="center">
  <tr>
    <td><input type="text" name="role"  id="role" placeholder="请输入新增的角色名"  onblur="checkDate()"/><samp id="us"></samp></td>
  </tr>
  <tr>
