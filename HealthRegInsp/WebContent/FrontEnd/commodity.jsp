...
<c:forEach items="${setList }" var="setmealBean">
  ...
  <table width="800" border="1" align="center">
    ...
    $(function(){
      ...
      <td><span class="STYLE2">${setmealBean.setmeal }</span></td>
    </tr>
    <tr>
      <td><span class="STYLE4">简介：${setmealBean.setmeal }</span></td>
    </tr>
    <tr>
      <td><span class="STYLE3">优惠价：${setmealBean.discount*setmealBean.countAll }
    <input type="hidden" id="hidden" name="hidden" value="${setmealBean.discount*setmealBean.countAll }"/>
      </span></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>购买数量：
		...
		价格：<input id="total" name="" type="text" value="${setmealBean.discount*setmealBean.countAll }"style="width:30px;"/>  
	</td>

    </tr>
    <tr>
      <td><label>
        <input type="submit" name="Submit2" value="立即购买" />
