							...
							<form id="form1" name="form1" method="post" action="<%=path%>myCompAction/EditCompInfo.action"
								...
								<div align="center">
									<table width="490" border="1" align="center">
										<tr>
											<td width="112">头像</td>
											<td width="362"><input type="file" name="fileact" id="fileact" /> <img src="" id="img0"
										...
										<c:forEach items="${compList}" var="comp">
											<tr>
												...
												<td><label for="textfield"></label> <input type="text" name="address" id="textfield"
													value="${comp.address}" /></td>
											</tr>
											<tr>
												<td>联系人</td>
												<td><label for="textfield2"></label> <input type="text" name="contacts" id="textfield2"
													value="${comp.contacts}" /></td>
											</tr>
											<tr>
												<td>电话</td>
												<td><label for="textfield3"></label> <input type="text" name="phone" id="textfield3"
													value="${comp.phone}" /></td>
											</tr>
										</c:forEach>
										<tr>
											...
											<td colspan="2">
												<div align="center">
													<input type="submit" name="button" id="button" value="提交" /> <input type="reset" name="button3"
														id="button3" value="重置" />
												</div>
											</td>
										</tr>
