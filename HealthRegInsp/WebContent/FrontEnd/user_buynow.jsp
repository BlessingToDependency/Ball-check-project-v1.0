...
<meta name="keywords" content="健康,体检部," />
...
<div id="sitecontent">
  ...
  <div class="npagePage " id="npagePage">
    ...
    <div class="content">
        ...
        收货人信息：
          ${ sessionScope.userBean.company} 
           ${ sessionScope.userBean.phone} 
            ${ sessionScope.userBean.address}
            
             
 	订单信息:
 			产品名称${setmealBean.setmeal }
 			单价${setmealBean.discount }
 			数量${setmealBean.number }
 			小计${setmealBean.countAll }
